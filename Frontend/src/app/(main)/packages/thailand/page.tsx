...
export const metadata: Metadata = {
  title: "Thailand Tour Packages | Bharat Yatra Travels",
  description: "A paradise of tropical beaches and vibrant culture. Explore Bangkok and the pristine islands of Phuket and Krabi with our curated Thailand itineraries.",
};

const highlights = [
  "Phi Phi Island Speedboat Day Tour",
  "Bangkok Grand Palace & Wat Pho Temple Visit",
  "Authentic Thai Street Food Walking Tour",
  "Krabi Rock Climbing & Snorkelling Adventure",
  "Chiang Mai Night Bazaar & Elephant Sanctuary",
];

const dummyPackages = [
  { title: "Bangkok & Phuket Combo", duration: "5 Nights / 6 Days", price: "38,999" },
  { title: "Thailand Islands Explorer", duration: "6 Nights / 7 Days", price: "46,999" },
  { title: "Chiang Mai Cultural Journey", duration: "4 Nights / 5 Days", price: "29,999" },
  { title: "Thailand Honeymoon Special", duration: "7 Nights / 8 Days", price: "58,999" },
];
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-[66px]">
      <div
        ...
        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?auto=format&fit=crop&q=80&w=1920')", backgroundSize: "cover", backgroundPosition: "center" }}
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          <p className="text-slate-200 text-lg max-w-2xl leading-relaxed">
            Tropical beaches, ancient temples, and vibrant street food — Thailand has it all.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-8">
            <section className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
              ...
              <p className="text-slate-600 leading-[1.9] text-[15px]">
                A paradise of tropical beaches and vibrant culture that never disappoints. Explore the bustling, colourful streets 
                of Bangkok, float through its iconic canals, and immerse in the serene beauty of Phuket and Krabi&apos;s emerald 
                waters and untouched limestone cliffs. From luxurious island resorts to authentic temple experiences, 
                our Thailand packages offer the perfect blend of relaxation, adventure, and cultural discovery.
              </p>
              <div className="grid grid-cols-3 gap-4 mt-8 pt-8 border-t border-slate-50">
                {[{ icon: Clock, label: "Duration", val: "4–8 Days" }, { icon: Users, label: "Group Size", val: "2–12 Pax" }, { icon: MapPin, label: "Highlights", val: "Thailand" }].map(({ icon: Icon, label, val }) => (
            ...
            <section>
              <h2 className="text-2xl font-extrabold text-gray-900 mb-6">Thailand Holiday Packages</h2>
          ...
          <aside className="space-y-6">
            <div className="bg-blue-600 rounded-3xl p-8 text-white shadow-xl shadow-blue-900/10 text-center relative overflow-hidden">
              ...
              <h3 className="text-xl font-bold mb-2 relative z-10">Plan Your Thailand Trip</h3>
              <p className="text-blue-100 text-sm mb-6 relative z-10">Custom Thailand packages for solo, couple, and family travel.</p>
