...
export const metadata: Metadata = {
  title: "South India Tour Packages | Bharat Yatra Travels",
  description: "Immerse yourself in the tropical tranquility of South India. Enjoy backwaters of Kerala, magnificent temples of Tamil Nadu, and the lush green hills of Munnar.",
};

const highlights = [
  "Serene Kerala Backwaters Houseboat Experience",
  "Ancient Dravidian Temples & Heritage Walks",
  "Sprawling Tea Gardens & Spice Plantations",
  "Pristine Beaches of Kovalam & Varkala",
  "UNESCO World Heritage Sites in Hampi",
];

const dummyPackages = [
  { title: "Kerala Backwaters Retreat", duration: "5 Nights / 6 Days", price: "27,999" },
  { title: "Tamil Nadu Temple Circuit", duration: "6 Nights / 7 Days", price: "22,999" },
  { title: "Coorg & Munnar Escape", duration: "4 Nights / 5 Days", price: "18,999" },
  { title: "Karnataka Heritage Tour", duration: "5 Nights / 6 Days", price: "24,999" },
];
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-[66px]">
      ...
      <div
        ...
        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1596895111956-bf57b01b6a37?auto=format&fit=crop&q=80&w=1920')", backgroundSize: "cover", backgroundPosition: "center" }}
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          <p className="text-slate-200 text-lg max-w-2xl leading-relaxed">
            Backwaters, temples, and tropical hills — the timeless charm of South India awaits.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-8">
            <section className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
              ...
              <p className="text-slate-600 leading-[1.9] text-[15px]">
                Immerse yourself in the tropical tranquility of South India. Enjoy the serene backwaters of Kerala on a traditional houseboat, 
                witness the magnificent Dravidian temples of Tamil Nadu, and explore the lush green hills of Munnar and Coorg. 
                South India offers an incredibly diverse experience that blends culture, nature, and spirituality with seamless ease.
              </p>
              <div className="grid grid-cols-3 gap-4 mt-8 pt-8 border-t border-slate-50">
                {[{ icon: Clock, label: "Duration", val: "4–8 Days" }, { icon: Users, label: "Group Size", val: "2–12 Pax" }, { icon: MapPin, label: "Highlights", val: "15+ Cities" }].map(({ icon: Icon, label, val }) => (
            ...
            <section>
              <h2 className="text-2xl font-extrabold text-gray-900 mb-6">Popular South India Packages</h2>
          ...
          <aside className="space-y-6">
            <div className="bg-blue-600 rounded-3xl p-8 text-white shadow-xl shadow-blue-900/10 text-center relative overflow-hidden">
              ...
              <p className="text-blue-100 text-sm mb-6 relative z-10">Custom South India itineraries tailored just for you.</p>
