...
export const metadata: Metadata = {
  title: "Golden Triangle Tour | Bharat Yatra Travels",
  description: "The classic Indian experience. Cover Delhi, Agra, and Jaipur. Witness the Taj Mahal at sunrise and explore historic forts in one perfectly planned trip.",
};

const highlights = [
  "Sunrise Taj Mahal Guided Tour in Agra",
  "Delhi Capital Heritage Sightseeing — Red Fort, Qutub Minar",
  "Jaipur Pink City Amber Fort & City Palace",
  "Private AC Car Transfers Between All Cities",
  "Expert English-Speaking Local Guides Included",
];

const dummyPackages = [
  { title: "Classic Golden Triangle", duration: "5 Nights / 6 Days", price: "21,999" },
  { title: "Golden Triangle with Ranthambore", duration: "7 Nights / 8 Days", price: "34,999" },
  { title: "Golden Triangle Luxury", duration: "6 Nights / 7 Days", price: "39,999" },
  { title: "Golden Triangle Express", duration: "3 Nights / 4 Days", price: "14,999" },
];
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-[66px]">
      <div
        ...
        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1548013146-72479768bada?auto=format&fit=crop&q=80&w=1920')", backgroundSize: "cover", backgroundPosition: "center" }}
      >
        <div className="absolute inset-0 bg-slate-900/50" />
        <div className="absolute inset-0 bg-gradient-to-t from-slate-950/80 via-transparent to-transparent" />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <span className="inline-block text-amber-400 text-xs font-black uppercase tracking-widest mb-4 border border-amber-400/30 bg-amber-400/10 px-3 py-1 rounded-full">Most Popular</span>
          ...
          <p className="text-slate-200 text-lg max-w-2xl leading-relaxed">
            Delhi, Agra, Jaipur — India&apos;s most iconic route, perfected by our travel experts.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-8">
            <section className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
              ...
              <p className="text-slate-600 leading-[1.9] text-[15px]">
                The classic Indian experience that every traveller must complete at least once. Cover the iconic Golden Triangle of 
                Delhi, Agra, and Jaipur. Witness the ethereal Taj Mahal at the break of dawn, explore the imposing Red Fort 
                in the heart of Delhi, and stroll through the vibrant Pink City of Jaipur — all in one perfectly planned, 
                hassle-free trip with our expert local drivers and guides.
              </p>
              <div className="grid grid-cols-3 gap-4 mt-8 pt-8 border-t border-slate-50">
                {[{ icon: Clock, label: "Duration", val: "3–8 Days" }, { icon: Users, label: "Group Size", val: "2–12 Pax" }, { icon: MapPin, label: "Highlights", val: "3 Major Cities" }].map(({ icon: Icon, label, val }) => (
            ...
            <section>
              <h2 className="text-2xl font-extrabold text-gray-900 mb-6">Golden Triangle Packages</h2>
          ...
          <aside className="space-y-6">
            <div className="bg-blue-600 rounded-3xl p-8 text-white shadow-xl shadow-blue-900/10 text-center relative overflow-hidden">
              ...
              <p className="text-blue-100 text-sm mb-6 relative z-10">Personalized Golden Triangle itinerary crafted just for you.</p>
