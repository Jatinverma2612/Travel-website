...
export const metadata: Metadata = {
  title: "Rajasthan Tour Packages | Bharat Yatra Travels",
  description: "Step into the land of kings. Rajasthan offers royal heritage, magnificent forts in Jaipur and Jodhpur, and the golden sand dunes of Jaisalmer.",
};

const highlights = [
  "Overnight Desert Safari & Luxury Camping in Jaisalmer",
  "Exclusive Palaces & Forts Tour — Amber, Mehrangarh",
  "Authentic Rajasthani Cultural Evenings & Folk Music",
  "Pushkar Camel Fair & Holy Lake Visits",
  "City Palace of Udaipur — Venice of the East",
];

const dummyPackages = [
  { title: "Jaipur – Jodhpur – Jaisalmer Royal Circuit", duration: "6 Nights / 7 Days", price: "29,999" },
  { title: "Udaipur Lake City Romance", duration: "3 Nights / 4 Days", price: "16,999" },
  { title: "Desert Rajasthan Safari", duration: "5 Nights / 6 Days", price: "23,999" },
  { title: "Complete Rajasthan Explorer", duration: "9 Nights / 10 Days", price: "47,999" },
];
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-[66px]">
      <div
        ...
        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1477587458883-47145ed94245?auto=format&fit=crop&q=80&w=1920')", backgroundSize: "cover", backgroundPosition: "center" }}
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-white tracking-tight mb-4 leading-tight max-w-3xl">
            Rajasthan Royal Packages
          </h1>
          <p className="text-slate-200 text-lg max-w-2xl leading-relaxed">
            Forts, palaces, and golden sand dunes — embark on a regal journey through the Land of Kings.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-8">
            <section className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
              ...
              <p className="text-slate-600 leading-[1.9] text-[15px]">
                Step into the land of kings. Rajasthan offers an unparalleled experience of royal heritage with magnificent forts 
                in Jaipur and Jodhpur, the serene lakes of Udaipur, and the golden sand dunes of Jaisalmer. 
                Every city is a vibrant chapter of history, art, and culture waiting to be discovered. Our curated royal circuits 
                ensure you experience the grandeur of Rajputana in absolute comfort.
              </p>
              <div className="grid grid-cols-3 gap-4 mt-8 pt-8 border-t border-slate-50">
                {[{ icon: Clock, label: "Duration", val: "3–10 Days" }, { icon: Users, label: "Group Size", val: "2–15 Pax" }, { icon: MapPin, label: "Highlights", val: "8+ Cities" }].map(({ icon: Icon, label, val }) => (
            ...
            <section>
              <h2 className="text-2xl font-extrabold text-gray-900 mb-6">Popular Rajasthan Packages</h2>
          ...
          <aside className="space-y-6">
            <div className="bg-blue-600 rounded-3xl p-8 text-white shadow-xl shadow-blue-900/10 text-center relative overflow-hidden">
              ...
              <p className="text-blue-100 text-sm mb-6 relative z-10">Custom Rajasthan royal tours designed for your comfort.</p>
