...
export const metadata: Metadata = {
  title: "Bali Tour Packages | Bharat Yatra Travels",
  description: "Experience the Island of the Gods. Bali offers white sandy beaches, iconic cliffside temples, and lush terraced rice paddies. Perfect for honeymoons.",
};
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-[66px]">
      <div
        ...
        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1537996191371-bd8c676d96ea?auto=format&fit=crop&q=80&w=1920')", backgroundSize: "cover", backgroundPosition: "center" }}
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-white tracking-tight mb-4 leading-tight max-w-3xl">
            Bali Exotic Packages
          </h1>
          <p className="text-slate-200 text-lg max-w-2xl leading-relaxed">
            Island temples, tropical rice fields, and pristine beaches — Bali is pure paradise.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-extrabold text-gray-900 mb-6">Bali Holiday Packages</h2>
          ...
          <aside className="space-y-6">
            <div className="bg-blue-600 rounded-3xl p-8 text-white shadow-xl shadow-blue-900/10 text-center relative overflow-hidden">
              ...
              <h3 className="text-xl font-bold mb-2 relative z-10">Plan Your Bali Trip</h3>
              <p className="text-blue-100 text-sm mb-6 relative z-10">Custom Bali honeymoon or group tours designed for you.</p>
